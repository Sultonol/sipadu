            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('user.complaints') }}"
                        class="text-gray-600 hover:text-blue-700 text-sm font-medium transition-colors">
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button onclick="scrollToSection('getting-started')"
                    class="flex items-center p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors text-left">
                ...
                <button onclick="scrollToSection('create-complaint')"
                    class="flex items-center p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors text-left">
                ...
                <button onclick="scrollToSection('check-status')"
                    class="flex items-center p-4 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors text-left">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Masuk dengan email dan password yang sudah terdaftar
                                </p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Dashboard menampilkan ringkasan dan statistik pengaduan
                                </p>
                            </div>
                        </div>
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Navigasi menggunakan menu di atas atau mobile
                                    navigation</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                <div
                                    class="w-6 h-6 bg-green-600 text-white rounded-full flex items-center justify-center font-bold text-xs">
                                    1</div>
                                <div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                            ...
                            <p class="text-sm text-blue-800">Gunakan tombol "Lokasi Saat Ini" untuk mengisi koordinat
                                otomatis</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 text-white text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="mailto:support@sipengmas.go.id"
                    class="inline-flex items-center px-4 py-2 bg-white text-blue-600 rounded-lg font-medium hover:bg-blue-50 transition-colors">
